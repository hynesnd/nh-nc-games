...
- Write your README, including the following information:
  - [Y] Link to hosted version
  - [Y] Write a summary of what the project is
  - [Y] Provide clear instructions of how to clone, install dependencies, seed local database, and run tests
  - [Y] Include information about how to create the two `.env` files
  - [Y] Specify minimum versions of `Node.js` and `Postgres` needed to run the project
